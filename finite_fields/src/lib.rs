...
pub const SIGNED_G : I256 = I256::from_i128(0x4040fbed12ee470fb5038f9c18f6f7d1);
...
pub fn primitive_nth_root (n : i32) -> IntPG {
    assert! (I256::from(n) <= I256::ONE.shl(119) && (n & (n - 1)) == 0);

    let mut root = constant(SIGNED_G);
    let mut order = I256::ONE.shl(119);
