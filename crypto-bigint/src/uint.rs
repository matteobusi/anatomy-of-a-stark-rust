...
use core::{fmt, marker::StructuralPartialEq};
...
#[derive(Copy, Clone, Hash, ConstParamTy)]
...
/// Since PartialEq differs from the derived one just by the fact it is constant time
/// this impl should be fine.
impl<const LIMBS: usize> StructuralPartialEq for Uint<LIMBS> { }
